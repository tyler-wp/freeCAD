...
$(document).ready(function () {
    ...
    $('#staffSettingsPanelWizard').bootstrapWizard({'tabClass': 'nav nav-tabs navtab-wizard nav-justified'});
    $('#editingUserPanelWizard').bootstrapWizard({'tabClass': 'nav nav-tabs navtab-wizard nav-justified'});
    $('#searchNameWizard').bootstrapWizard({'tabClass': 'nav nav-tabs navtab-wizard nav-justified'});
    $('#civTabbedStyleWizard').bootstrapWizard({'tabClass': 'nav nav-tabs navtab-wizard nav-justified'});
    ...
    if (isMobile()) {
       toastr.error('You appear to be on a Mobile Device. freeCAD does NOT support Mobile Devices. Please switch to a computer.')
    }
