$(document).ready(function () {
    ...
    $('#setPenalCode').ajaxForm(function (error) {
        error = JSON.parse(error);
        if (error['msg'] === "") {
            toastr.success('Penal Code Set', 'System:', {
                timeOut: 10000
            })
        } else {
            toastr.error(error['msg'], 'System:', {
    ...
    $('#setLiveMap').ajaxForm(function (error) {
        error = JSON.parse(error);
        if (error['msg'] === "") {
            toastr.success('LiveMap Set', 'System:', {
                timeOut: 10000
            })
        } else {
            toastr.error(error['msg'], 'System:', {
...
function setTheme(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET", "inc/backend/staff/settings/setTheme.php?q=" + str, true);
        xmlhttp.send();
        toastr.success('Theme Updated.', 'System:', {
            timeOut: 10000
        })
    }
}
...
function setCivLayout(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET", "inc/backend/staff/settings/setCivLayout.php?q=" + str, true);
        xmlhttp.send();
        toastr.success('Settings Updated.', 'System:', {
            timeOut: 10000
        })
...
function setCivCharLimit(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET", "inc/backend/staff/settings/setCivCharLimit.php?q=" + str, true);
        xmlhttp.send();
        toastr.success('Settings Updated.', 'System:', {
            timeOut: 10000
        })
