          ...
          echo '<table class="table table-borderless">
            ...
            while ($rowMyCallList = $resultMyCallList->fetch(PDO::FETCH_ASSOC)) {
              ...
              <tr>
                ...
                <td><a href="javascript:void(0);" data-href="inc/backend/user/dispatch/getCallInfo.php?id='.$rowCallInfo['call_id'].'" class="btn btn-block btn-sm btn-info openCallInfoModal">View</a></td>
              </tr>';
        }
        echo '</tbody>
      </table>';
