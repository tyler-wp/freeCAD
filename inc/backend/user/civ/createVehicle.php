...
$newVeh['plate'] = strip_tags($_POST['plate']);
$newVeh['color'] = strip_tags($_POST['color']);
$newVeh['model'] = strip_tags($_POST['model']);
$newVeh['insurance_status'] = strip_tags($_POST['insurance_status']);
$newVeh['registration_status'] = strip_tags($_POST['registration_status']);
