    ...
    if ($countActiveCalls === 0) {
      ...
      ';
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<td><center><a href="javascript:void(0);" data-href="inc/backend/user/dispatch/getCallInfo.php?id=' . $row['call_id'] . '" class="btn btn-block btn-sm btn-info openCallInfoModal">View</a></center></td>';
            echo "</tr>";
        }
        echo '</table>';
